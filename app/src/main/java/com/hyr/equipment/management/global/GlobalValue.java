...
public class GlobalValue {
    ...
    // public static String BASE_URL = "http://192.168.1.3:8080/EquipmentManagementWebServer";
    public static String BASE_URL = "http://10.0.2.2:8080/EquipmentManagementWebServer";
    //public static String BASE_URL = "http://47.100.40.65:80/EquipmentManagementWebServer";
    //http://huangyueranbbc.xicp.net:19456/
