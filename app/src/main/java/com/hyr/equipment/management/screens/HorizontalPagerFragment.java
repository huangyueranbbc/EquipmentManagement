package com.hyr.equipment.management.screens;
...
public class HorizontalPagerFragment extends Fragment {
    ...
    public HorizontalPagerFragment(MainActivity mainActivity) {
    ...
    public void onViewCreated(final View view, @Nullable final Bundle savedInstanceState) {
        ...
        horizontalInfiniteCycleViewPager.setAdapter(new HorizontalPagerAdapter(getContext(), false,mainActivity));
