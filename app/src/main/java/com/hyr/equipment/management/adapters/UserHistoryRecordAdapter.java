...
//创建自定义adapter
public class UserHistoryRecordAdapter extends BaseAdapter {
    private LayoutInflater mlayoutInflater;
    private List<HashMap<String, String>> mData;  //填充的数据 pojo

    public UserHistoryRecordAdapter(Context context, List<HashMap<String, String>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv3.setText(mData.get(position).get("eq_endtime").toString());
        TextView tv4 = (TextView) convertView.findViewById(R.id.textView4);
        tv4.setText(mData.get(position).get("eq_status").toString());
        return convertView;
    }
}